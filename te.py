"""Nota: profesor procuraré no usar tildes ni letra ñ, salvo en str, para transitar hacia la redacción de código 
completamente en idioma inglés en los siguientes desafíos. 
Actualmente ya redacto commits de GitHub en ese idioma y siguiendo medianamente la convención"""
